...
const AboutMe = () => {
	...
	return (
		<section className="bg-gr-bg-1-b flex flex-col items-start gap-[32px] p-[32px]">
			<h2
			...
			<button
				...
				className={`bg-gr-project-btn text-h5 text-fg-1  
							hover:animate-button-in h-h6 flex gap-[8px] 
							rounded-[4px] bg-linear-to-r bg-size-[300%] px-[48px] 
							py-[24px] hover:rounded-[16px] hover:bg-position-[100%]`}>
